    ...
    <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Blog - Color Coating </h1>
            ...
            <div class="col-lg-12">
                ...
                <div class="mb-5">
                   <img class="img-fluid w-50 rounded mb-5" src="img/blog-3.jpg" alt=""> 
                    ...
                    <h2>2. Popular Color Coating Techniques</h2>
                    <ul>
                        <li><b>Powder Coating:</b> A durable and eco-friendly coating method ideal for metal and glass packaging.</li>
                        <li><b>Spray Coating:</b> A versatile technique used for even application on plastic, glass, and metal surfaces.</li>
