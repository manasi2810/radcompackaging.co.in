    ...
    <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="manufacturing blog.php" class="h5 text-white">Blog - Manufacturing</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-12">
                <!-- Blog Detail Start -->
                <div class="mb-5">
                   <img class="img-fluid w-50 rounded mb-5" src="img/blog-2.jpg" alt=""> 
                    <h1 class="mb-4">The Future of Manufacturing: Trends, Innovations, and Sustainability</h1>
                    <p>Manufacturing is at the heart of industrial growth, driving economies and technological advancements. As industries evolve, automation, sustainability, and smart manufacturing are reshaping the way products are made.</p> 
                    <h2>1. Importance of Manufacturing in Business</h2>
                    <p>Manufacturing ensures mass production, quality control, and cost efficiency. It fuels economic growth, supports employment, and fosters innovation through continuous improvement in production techniques.</p>
                    <h2>2. Latest Manufacturing Trends</h2>
                    <ul> 
